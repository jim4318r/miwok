...
public class ColorAdapter extends ArrayAdapter<Color> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Get the {@link Color} object located at this position in the list
        Color currentColor = getItem(position);

        // Find the TextView in the list_item.xml layout with the ID version_name
        TextView miwokTextView = (TextView) listItemView.findViewById(R.id.miwok_text_view);
        // Get the miwok text name from the current Color object and
        ...
        defaultText.setText(currentColor.getDefaultTranslation());
